...
i stedet for standard layoutet. </td>
			...
			<tr>
				<td width="309">&nbsp;</td>
				<td width="179">
					<a href="#"><input type="button" name="sange.html22" value="Gem sang layout" class="submit_btn" /></a>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
					<a href="#"><input type="button" name="sange.html23" value="Overskriv standard layout" class="submit_btn" /></a>
				</td>
			</tr>
			</table>
		</div>
